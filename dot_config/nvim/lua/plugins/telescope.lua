return {
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>/", builtin.live_grep, { desc = "[/] telescope Search by Grep" })
      vim.keymap.set("n", "<leader>sd", builtin.diagnostics, { desc = "telescope [s]earch [d]iagnostics" })
      vim.keymap.set("n", "<leader>tsr", builtin.resume, { desc = "[t]elescope [s]earch [r]esume" })
      ...
      end, { desc = "Telescope [s]earch Current [b]uffer" })
