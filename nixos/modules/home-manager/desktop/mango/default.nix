    ...
    lib.mkMerge [
      {
        wayland.windowManager.mango = {
          ...
          settings = ''
            ...
            bind=SUPER,t,spawn,${config.home.homeDirectory}/.local/bin/raise-cycle-or-spawn mango kitty
            bind=SUPER,b,spawn,${config.home.homeDirectory}/.local/bin/raise-cycle-or-spawn mango firefox
            bind=SUPER,e,spawn,${config.home.homeDirectory}/.local/bin/raise-cycle-or-spawn mango dolphin
            bind=SUPER,m,spawn,${config.home.homeDirectory}/.local/bin/raise-cycle-or-spawn mango spotify
            bind=CTRL+SUPER,s,spawn,${config.home.homeDirectory}/.local/bin/raise-cycle-or-spawn mango steam
            bind=SUPER+SHIFT,d,spawn,${config.home.homeDirectory}/.local/bin/raise-cycle-or-spawn mango discord
            ...
            source=${config.home.homeDirectory}/.config/mango/dms/outputs.conf
