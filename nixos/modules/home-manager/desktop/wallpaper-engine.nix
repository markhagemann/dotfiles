...

{
  ...
  config = lib.mkIf cfg.enable (let
    ...
    wallpaperIds = [
      "3156173237" "3249337639" "3248789055" "3015692932" 
      "3250483470" "3251349487" "2376341991" "1945149029" 
      "3174492446" "3451450351" "3203241401" "3428926953" 
      "3340426790" "3384222744" "2609314607" "2614505463" 
      "2797293393" "1214148605"
    ];
    ...
    '';
  in {
    services.linux-wallpaperengine.enable = false;
    home.packages = [ pkgs.linux-wallpaperengine playlistScript pkgs.coreutils pkgs.procps ];
