...
, qt6Packages, glib, gtk3, mesa, nspr, nss, systemd, xorg, libudev0-shim, curl
, openssl, qt6, libnl, libcap_ng }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://github.com/Windscribe/Desktop-App/releases/download/v${version}/windscribe-cli_${version}_amd64.deb";
